	...
	<div class="row">
		<div id="dashSidebar" class="col-sm-3 col-md-2 sidebar-div">
			<ul class="nav sidebar-nav">
				...
				<li><a class="link" href="#incompleteAssignments">Incomplete
						Assignments</a></li>
				<li><a class="link" href="#submittedAssignments">Submitted
						Assignments</a></li>
				<li><a class="link" href="#gradedAssignments">Graded
						Assignments</a></li>
			</ul>
		</div>
		<!-- dashSidebar -->
		...
		<div id="dashMain" class="col-sm-9 col-md-10">
			<h1 class="page-header">
				...
				's Progress <span class="glyphicon glyphicon-stats"></span>
			...
			<div id="assignments">
				...
				<div id="submittedAssignments">
					...
					<c:forEach var="submission" items="${submissions}">
						<c:if
							...
							<h4>
								<c:out value="${submission.assignment.name}" />
							</h4>
							<c:url
								value="/dashboard/${courseId}/${submission.lesson.moduleId}/${submission.lesson.lessonId}"
								var="lessonHref" />
							<p>
								<strong>Lesson: </strong><a href="${lessonHref}"><c:out
					...
					<c:forEach var="submission" items="${submissions}">
						<c:if
							...
							<p>
								<strong>Score: </strong>
								<c:out
									value="${submission.studentAssignment.score}/${submission.assignment.maxScore}" />
							</p>
				...
				<div id="incompleteAssignments">
					...
					<c:forEach var="submission" items="${submissions}">
						<c:if test="${!submission.studentAssignment.submitted}">
							<div class="incomplete-assignment-div">
								...
								<p>
									<c:out value="${submission.assignment.description}" />
								</p>
								<p>
