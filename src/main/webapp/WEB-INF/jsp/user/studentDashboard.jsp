	...
	<div class="row">
		...
		<div class="concreteImage">
			...
			<div id="dashMain" class="col-sm-9 col-md-10">
				<h1 class="page-header">Your Courses</h1>
				...
				<div id="courses">
					<c:forEach var="course" items="${studentsCourses}">
						...
						<h3>
							<a class="link" href="${courseDetailHref}">${course.name}</a>
						</h3>
						<c:url
							value="/dashboard/${course.courseId}/${currentUser.userId}/progress"
							var="currentProgress" />
						<p>
							<a class="btn btn-success" href="${currentProgress}">Current
								Progress</a>
						</p>
